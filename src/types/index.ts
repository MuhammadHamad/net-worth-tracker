...
export interface BorrowedLoan { id: string; type: 'borrowed'; personOrEntity: string; amount: number; repaidAmount?: number; date: string; dueDate?: string; notes?: string; isSettled: boolean; createdAt: string; updatedAt?: string; }
export interface LentLoan { id: string; type: 'lent'; personOrEntity: string; amount: number; repaidAmount?: number; date: string; expectedReturnDate?: string; notes?: string; isSettled: boolean; createdAt: string; updatedAt?: string; }
