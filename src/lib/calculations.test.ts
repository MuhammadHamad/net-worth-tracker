...
const asset = (estimatedValue: number): Transaction => ({ id: crypto.randomUUID(), type: 'asset', name: 'Thing', estimatedValue, category: 'investments', dateAdded: '2026-06-01', createdAt: '2026-06-01T00:00:00Z' });
...
describe('calculateNetWorth', () => {
  ...
  it('goes negative when you borrow and spend it', () => {
    // Borrowed 100k (neutral) then spent it on an expense: the debt remains.
